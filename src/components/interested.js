// things to check if the user is authenticated
// filter the sellers to those that are only interested
...
import {loadToken} from '../_services/user_services'
 ...
 class InterestedSeller extends React.Component {
    ...
    return (
      ...
      <table class="min-w-full table-auto">
        ...
        {this.state.thrifters.map(thrifter => 
            // return thirifter.status != thrifters.status
...
export default InterestedSeller 