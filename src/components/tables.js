...
export default Sellertable 
 ...
 {/* <tr class="bg-white border-4 border-gray-200">
            ...
            <td>
              <span class="text-center ml-2 font-semibold">500 - 2000 Ksh</span>
            </td>
            <td class="px-16 py-2">
          ...
          <tr class="bg-white border-4 border-gray-200">
            ...
            <td class="px-16 py-2">
              <button class="bg-red-400 text-white px-4 py-2 border rounded-md hover:bg-white hover:border-indigo-500 hover:text-black ">
                offboarded
              </button>
            </td>
            <td class="px-16 py-2">
